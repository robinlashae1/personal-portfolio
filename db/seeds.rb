...
Blog.create(title:"React: Componenets",preview:"When first learning React, a key concept you\'ll encounter are components. These are essentially building blocks for your app. They help to make your code “dry”, dynamic and are an essential part of what developers like to call SOC...",url:"https://robin-rocking-through-code.tumblr.com/post/666231208072642561/react-componenets")
Blog.create(title:"A Basic guide to Active Record Commands",preview:"When transitioning to Ruby\'s active record, the commands can be a little long winded and tedious. Here i have provided a cheat sheet to basic AR commands...",url:"https://robin-rocking-through-code.tumblr.com/post/668134404121624576/a-basic-guide-to-active-record-commands")
